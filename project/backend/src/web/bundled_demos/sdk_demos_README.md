...
**Как подключить бота к чату и узнать chat id:** страница коллектора `http://127.0.0.1:8000/docs/telegram` (BotFather, группа, `getUpdates`, команды `/stats` и `/report` в этом чате).
